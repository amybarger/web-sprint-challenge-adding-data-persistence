      ...
      return knex("tasks").insert([
        {
          ...
          description:
            "Draw the number of days and months, binding them together.",
          project_id: 1
        },
        {
          id: 2,
        ...
        },
        {
          ...
          description:
            "Grab a blank canvas, have paint colors ready on pallette.",
          project_id: 2
        },
        {
          id: 4,
        ...
        },
        {
          ...
          task: "Podcast prep",
          description:
            "Buy the needed equipment and think about guests to join.",
          project_id: 3
        },
        {
          id: 5,
